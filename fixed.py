...
button_bg = pygame.image.load('D:/output/button-large.png').convert_alpha()
main_ui_img = pygame.image.load('D:/output/main-ui.png').convert_alpha()
check_img = pygame.image.load('D:/output/check.gif').convert_alpha()
x_img = pygame.image.load('D:/output/x.gif').convert_alpha()
...
pygame.mixer.music.load("D:/output/bg_music.mp3")
