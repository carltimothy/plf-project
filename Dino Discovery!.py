...
pygame.init()
icon = pygame.image.load(resource_path("assets/Cute-Dinosaur-Left.png"))
...
bg_img = pygame.image.load(resource_path('assets/menu.jpeg')).convert()
bg_img = pygame.transform.scale(bg_img, (800, 600))
dino_img = pygame.image.load(resource_path('assets/Cute-Dinosaur.png')).convert_alpha()
dino_left_img = pygame.image.load(resource_path('assets/Cute-Dinosaur-Left.png')).convert_alpha()
nugget_img = pygame.image.load(resource_path('assets/nuggies.webp')).convert_alpha()
button_bg = pygame.image.load(resource_path('assets/button-large.png')).convert_alpha()
main_ui_img = pygame.image.load(resource_path('assets/main-ui.png')).convert_alpha()
check_img = pygame.image.load(resource_path('assets/check.gif')).convert_alpha()
x_img = pygame.image.load(resource_path('assets/x.gif')).convert_alpha()
